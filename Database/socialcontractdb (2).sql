...
CREATE TABLE `tbl_adminacc` (
  ...
  `admin_IsRemoved` tinyint(4) DEFAULT 0
...
INSERT INTO `tbl_adminacc` (`admin_ID`, `admin_user`, `admin_pass`, `admin_salt`, `admin_type`, `admin_IsRemoved`) VALUES
(1, 'adminmain', '+HbtA74Q9TdNfQLfUqE4ZlXe1WHjS8b/', 'A1HfMT2+BXoN9A==', 0, 0);
...
--
ALTER TABLE `tbl_recordtbl`
  MODIFY `record_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;

--
-- AUTO_INCREMENT for table `tbl_studentinfo`
--
ALTER TABLE `tbl_studentinfo`
  MODIFY `tbl_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
COMMIT;
